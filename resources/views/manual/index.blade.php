        ...
        <div class="w-full flex justify-center items-center mt-4 mb-4">
            <div class="w-full flex justify-between items-center">
                <div class="flex justify-center items-center">
                    ...
                    <!-- Judul Section -->
                    <h1 class="font-extrabold text-[#353535] text-lg lg:text-[32px]">Manual</h1>
                </div>
            </div>
        </div>
        {{-- Top Part End --}}
    ...
    <div class="w-full bg-white p-3 rounded-lg md:rounded-xl shadow-md md:shadow-md">
        <div class="flex items-center justify-between">
            <div class="flex flex-col justify-center items-start">
                <h1 class="lg:text-2xl font-extrabold text-[#353535]">Manual Setting Lists</h1>
            ...
            @if (auth()->user()->role == 'admin')
                <div class="mr-2">
                    <a href="/admin/manual/create"
                        class="ds-btn ds-btn-sm ds-btn-primary border-none font-bold hidden lg:flex bg-[#AACA77] hover:bg-[#97bb60] text-[#353535] hover:text-white">Tambah</a>
                    <a href="/admin/manual/create"
                        class="ds-btn ds-btn-sm ds-btn-primary border-none font-bold flex lg:hidden bg-[#AACA77] hover:bg-[#97bb60] text-[#353535] hover:text-white">
